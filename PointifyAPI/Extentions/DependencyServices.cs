...
namespace PointifyAPI.Extentions;

public static class DependencyServices
{
    public static IServiceCollection AddUnitOfWork(this IServiceCollection services)
    {
        services.AddScoped<IUnitOfWork<PromotionEngineContext>, UnitOfWork<PromotionEngineContext>>();
        return services;
    }
    ...
    public static IServiceCollection AddDatabase(this IServiceCollection services)
    {
        ...
        services.AddDbContext<PromotionEngineContext>(options =>
            options.UseSqlServer(
                "Server=120.72.85.82,9033;Database=PromotionEngine;User Id=sa;Password=f0^wyhMfl*25;Encrypt=True;TrustServerCertificate=True"));
        return services;
    }
    ...
    public static IServiceCollection AddServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<IMembershipCardTypeService, MembershipCardTypeService>();
    ...
    public static IServiceCollection AddJwtValidation(this IServiceCollection services)
    {
        ...
        }).AddJwtBearer(options =>
        {
            ...
            {
                ValidIssuer = "Pointify",
                ValidateIssuer = true,
                ValidateAudience = false,
                ValidateIssuerSigningKey = true,
                IssuerSigningKey =
                    new SymmetricSecurityKey(
                        Encoding.UTF8.GetBytes("Pointify"))
            };
        });
        return services;
    }
